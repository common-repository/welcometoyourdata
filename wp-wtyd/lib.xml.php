...
class WTYDXML  {
   ...
   /** Joe Tan: Added tantan prefix to avoid potential conflicts with other wordpress plugins **/
   ...
   function tantan_xml($caseInsensitive = false, $attributesDirectlyUnderParent = false, $childTagsDirectlyUnderParent = false)
   {
